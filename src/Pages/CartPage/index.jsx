  ...
  const calculateTotalPrice = () => {
    ...
    return(
        <div className={s.cartPage}>
            ...
            <div className={s.backToStore}><p className={s.backToStoreP}>Back to Store</p> <img onClick={handleStepBack} src="./assets/forward.png" alt="" className={s.forward}/></div>
                ...
                <div className={s.orderDetails}>
                    ...
                    <div className={s.orderDetailsSumm}>
                        ...
                        <h3 className={s.orderDetailsSummH3}>{calculateTotalPrice().toFixed(2)}$</h3>
                    </div>
